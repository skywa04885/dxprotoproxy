...
public abstract class NetService {
    ...
    private @NotNull SimpleObjectProperty<State> state;

    /**
     * Constructs a new inactive net state.
     */
    public NetService() throws Exception {
        state = new SimpleObjectProperty<>(null, "State", createInactiveState());
    }
     ...
     */
    public @NotNull SimpleObjectProperty<State> stateProperty() {
        return state;
    }
     ...
     */
    public abstract @NotNull ObservableStringValue getName();
     ...
     */
    public abstract @NotNull ObservableStringValue getDescription();
}
