...
public class DXHttpConfiguratorTreeContextMenuFactory {
    private final DXHttpConfiguratorTreeContextMenuCallbacks configuratorTreeContextMenuCallbacks;

    public DXHttpConfiguratorTreeContextMenuFactory(DXHttpConfiguratorTreeContextMenuCallbacks configuratorTreeContextMenuCallbacks) {
